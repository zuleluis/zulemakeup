...
<header>
    <nav class="navigation">
        <ul class="menu">
            ...
            <%--<li class="menu"> <a class="menu" href="/zulemakeup/Servicios/Servicios.jsp">Aqui pondremos algo </a> </li>
            <li class="menu"> <a class="menu" href="/zulemakeup/Promociones/Promociones.jsp">Aqui igual</a> </li>
            <li class="menu"> <a class="menu" href="/zulemakeup/Productos/Productos.jsp">Aqui no se</a> </li> --%>
        </ul>
    </nav>
</header>
